...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x0a, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x22,
	...
	0x6f, 0x12, 0x18, 0x2e, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x48,
	0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x64, 0x65,
	0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65,
...
var file_helloworld_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: deployment.HelloRequest
	(*HelloReply)(nil),   // 1: deployment.HelloReply
}
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: deployment.Greeter.SayHello:input_type -> deployment.HelloRequest
	1, // 1: deployment.Greeter.SayHello:output_type -> deployment.HelloReply
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/deployment.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/deployment.Greeter/SayHello",
	}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "deployment.Greeter",
